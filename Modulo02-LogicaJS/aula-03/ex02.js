...
que contém nome, nota1 e nota2. Use o for para percorer esse array e 
calcular a média das duas notas de cada aluno. Ao final, imprimir o 
nome do aluno e a sua média
*/
const listaDeAlunos = [
  { nome: "João", notas: [8, 7] },
...
for (let i = 0; i < listaDeAlunos.length; i++) {
  ...
  const media = (aluno.notas[0] + aluno.notas[1]) / (aluno.notas.length);
  console.log(`${aluno.nome} teve a média de ${media}`);
}